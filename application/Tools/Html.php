...
class Html {
    ...
    public static function text($literal, $controlName, $controlValueObject = null,
                                $width = '', $className = '', $max = '', $placeHolder = '', $readOnly = '')
    {
        ...
        if ($literal) {
            ...
            return '<input ' . $readOnly . ' placeholder="' . $placeHolder . '" class="form-control" type="text" name="' . $controlName . '" id="'
