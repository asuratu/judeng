...
class Spell{
     ...
     * return "WO SHI ZUO ZHE"
     *
     * 例如：getChineseChar('我是作者',false,true,true); 首字母大写+其他字符串小写
     * return "Wo Shi Zuo Zhe"
     */
    static public function getChineseChar($string,$isOne=false,$upper=false,$three=false) {
        $spellArray = self::getArray();
        $str_arr = self::utf8_str_split($string,1); //将字符串拆分成数组
        $result = array();
     ...
     * @return array
     */
    static function utf8_str_split($str,$split_len=1) {
